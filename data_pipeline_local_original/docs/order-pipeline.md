...
The order pipeline is the reference implementation for event ingestion. It demonstrates the complete flow from event generation to Flink processing.
...
- Prints rows to Flink logs via the print connector
...
Watch the Flink TaskManager logs for the print sink output.
